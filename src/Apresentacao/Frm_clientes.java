...
public class Frm_clientes extends javax.swing.JInternalFrame {
    ...
    private void tb_listaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_listaMouseClicked
        ...
        txt_nome.setText(tb_lista.getValueAt(linha, 2).toString());
        txt_nome_pai.setText(tb_lista.getValueAt(linha, 3).toString());
        txt_nome_mae.setText(tb_lista.getValueAt(linha, 4).toString());
        cb_tipo_doc.setSelectedItem(tb_lista.getValueAt(linha, 5).toString());
    ...
    private void btn_apagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_apagarActionPerformed
        ...
        if (!txt_id_pessoa.getText().equals("")) {
            int confirmacao = JOptionPane.showConfirmDialog(rootPane, "Deseja apagar o CLIENTE");
            if (confirmacao == 0) {
                FClientes func = new FClientes();
    ...
    private void btn_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_salvarActionPerformed
        ...
        if (txt_nome_pai.getText().length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Insira o NOME do PAI do CLIENTE");
            txt_nome_pai.requestFocus();
            return;
        }
        if (txt_nome_mae.getText().length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Insira o NOME da MAE do CLIENTE");
            txt_nome_mae.requestFocus();
            return;
        }
        if (txt_num_doc.getText().length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Insira o NUMERO do DOCUMENTO  do CLIENTE");
            txt_num_doc.requestFocus();
            return;
        }
        if (txt_endereco.getText()
                .length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Insira a ENDERECO do CLIENTE");
        ...
        if (txt_telefone.getText()
                .length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Insira o TELEFONE do CLIENTE");
            txt_telefone.requestFocus();
            return;
        }
        if (txt_email.getText()
                .length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Insira o E-MAIL do CLIENTE");
        ...
        if (acao.equals("salvar")) {
            if (func.inserir(dts)) {
                JOptionPane.showMessageDialog(rootPane, "O CLIENTE foi inserido com SUCESSO");
                mostrar("");
                desativar();
            }
