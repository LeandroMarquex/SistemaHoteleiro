 ...
 */
public class Frm_burcar_quartos extends javax.swing.JFrame {

    /**
     * Creates new form Frm_burcar_quartos
     */
    public Frm_burcar_quartos() {
        initComponents();
        mostrar("");
    ...
    private void tb_listaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_listaMousePressed
        ...
        if(evt.getClickCount()==2){
          ...
          Frm_reservas.txt_numero_quarto.setText(valor);
          this.dispose();
      }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_burcar_quartos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_burcar_quartos().setVisible(true);
            }
        });
    }
